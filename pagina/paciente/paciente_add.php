...
//encriptando contraseña
	$pass=md5($password);
		...
		///finzalizo encriptacion
			...
			mysqli_query($con,"INSERT INTO usuario(usuario,password,
			imagen,tipo,nombre,apellido,telefono,correo
			,sexo,direccion,municipio,fecha)
				VALUES('$usuario','$pass','$img','$tipo','$nombre','$apellido','$telefono'
				,'$correo','$sexo','$direccion','$municipio','$fecha')")or die(mysqli_error($con));
	...
	//header('Location:../usuario.php');
		...
		$pass=$salt.$pass;
			...
			mysqli_query($con,"INSERT INTO usuario(usuario,
			password,imagen,tipo,
			nombre,apellido,telefono,correo,
			sexo,direccion,municipio,fecha)
				VALUES('$usuario','$pass','','$tipo',
				'$nombre','$apellido'
				,'$telefono','$correo','$sexo',
				'$direccion','$municipio','$fecha')
