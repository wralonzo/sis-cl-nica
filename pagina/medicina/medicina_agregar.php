        ...
        <form class="form-horizontal" method="post" action="medicina_add.php" enctype='multipart/form-data'>
                   ...
                   <div class="row">
                    <div class="col-md-3 btn-print">
                      ...
                      <input type="text" class="form-control pull-right" id="unidad" name="unidad"
           ...
           <div class="row">
                    <div class="col-md-3 btn-print">
                      ...
                      <input type="text" class="form-control pull-right" id="precio_compra" name="precio_compra" pattern="[0-9]+" title="Solo se permiten números" required>
                      </div>
                    </div>
                           <div class="col-md-4 btn-print">
           ...
           <div class="row">
                    <div class="col-md-3 btn-print">
                      ...
                      <input type="text" class="form-control pull-right" id="precio_venta" name="precio_venta" pattern="[0-9]+" title="Solo se permiten números" required>
                      </div>
                    </div>
                           <div class="col-md-4 btn-print">
                    ...
                    <div class="col-md-3 btn-print">
                      ...
                      <input type="text" class="form-control pull-right" id="stock" name="stock" pattern="[0-9]+" title="Solo se permiten números" required>
                      </div>
                    </div>
                           <div class="col-md-4 btn-print">
