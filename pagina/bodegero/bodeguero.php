...
#buscar{
 ...
 <!--end of modal-->
                ...
                <a class="btn btn-warning btn-print" href="bodeguero_agregar.php"    style="height:25%; width:15%; font-size: 12px " role="button">REGISTRAR</a>
 ...
 <!--end of modal-->
                  ...
                  <div class="box-header">
                  <h3 class="box-title"> LISTA BODEGUERO</h3>
                </div><!-- /.box-header -->
...
<?php
   // $branch=$_SESSION['branch'];
    $query=mysqli_query($con,"select * from usuario where tipo='bodeguero' ")or die(mysqli_error());
    $i=0;
