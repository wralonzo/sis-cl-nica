...
#buscar{
 ...
 <!--end of modal-->
                  ...
                  <h3 class="box-title"> REGISTRAR BODEGUERO </h3>

                </div><!-- /.box-header -->
                <a class="btn btn-warning btn-print" href="bodeguero.php"    style="height:25%; width:15%; font-size: 12px " role="button">Regresar</a>
        ...
        <form class="form-horizontal" method="post" action="bodeguero_add.php" enctype='multipart/form-data'>

       <input type="hidden" class="form-control" id="tipo" name="tipo" value="bodeguero" required>
