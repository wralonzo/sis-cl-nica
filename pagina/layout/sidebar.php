              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                      ...
                      ?>
                          ...
                          <li><a><i class="fa fa-database">
                          
                          </i> Medico<span class="fa fa-chevron-down"></span></a>
...
<li><a href="../cita/cita_bitacora.php">Bitacora de Citas</a></li>
  ...
  <?php
                      ...
                      ?>
                                  ...
                                  <?php
                       if ($tipo == "administrador" || $tipo == "farmaceutico" || $tipo == "bodeguero") {
                                      // Tu código aquí
...
<li><a href="../medicina/medicina_agregar.php">Agragar medidicna</a></li>
       ...
       <li><a href = "../preescripcion/preescripcion_paciente.php"><i class="fa fa-archive"></i> preescripcion paciente<span class="fa fa-chevron-right"></span></a>
           ...
           <li><a href = "../actividades_financieras/pagos_paciente.php"><i class="fa fa-archive"></i> 
           Pagos atencion<span class="fa fa-chevron-right"></span></a>
 ...
 <li><a href="../bodegero/bodeguero.php">Bodeguero</a></li>
