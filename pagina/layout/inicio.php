...

{
  $year = $_POST['year'];
        ...
        mysqli_query($con,"update temporada set year='$year' 
...
<?php
$num=0;
$select = mysqli_query($con, "select * from usuario where tipo='medico' ") 
...
?>
          ...
          <?php
                      ...
                      ?>
                               ...
                               <?php
                        if ($tipo=="administrador"  or $tipo=="medico" or $tipo=="farmaceutico" ) {
...
?>
          ...
          <?php
                 ...
                 <?php
                        if ($tipo=="administrador" or $tipo=="empleado" or $tipo=="farmaceutico" ) {
